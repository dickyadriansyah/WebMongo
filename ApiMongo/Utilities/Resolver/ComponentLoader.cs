...
namespace Utilities.Resolver
{
    ...
    internal class RegisterComponent : IRegisterComponent
    {
        ...
        public void RegisterTypeWithExternallyControlledLifetime<TFrom, TTo>(bool withInterception = false) where TTo : TFrom
        {
            this._container.RegisterType<TFrom, TTo>(new ExternallyControlledLifetimeManager());
        }
    }
}
